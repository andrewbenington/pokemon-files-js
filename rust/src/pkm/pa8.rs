...
use super::pkm::Pkm;
use crate::pkm::types::{ContestStats, FlagSet, Gender, HyperTraining, Stats};
...
impl Pkm<360, 360> for PA8 {
    ...
    fn from_bytes(bytes: &[u8]) -> Result<Self, String> {
        ...
        let mon = PA8 {
            ...
            gender: util::int_from_buffer_bits_le::<u8>(bytes, 34, 2, 2)
            ...
            scale: bytes[82],
            moves: [
                u16::from_le_bytes(to_sized_array(&bytes[84..86])),
                u16::from_le_bytes(to_sized_array(&bytes[86..88])),
                u16::from_le_bytes(to_sized_array(&bytes[88..90])),
            ...
            relearn_moves: [
                u16::from_le_bytes(to_sized_array(&bytes[138..140])),
                u16::from_le_bytes(to_sized_array(&bytes[140..142])),
                u16::from_le_bytes(to_sized_array(&bytes[142..144])),
                u16::from_le_bytes(to_sized_array(&bytes[144..146])),
            ],
            ...
            ball: bytes[311],
            egg_location_index: u16::from_le_bytes(to_sized_array(&bytes[312..314])),
            met_location_index: u16::from_le_bytes(to_sized_array(&bytes[314..316])),
            met_level: util::int_from_buffer_bits_le::<u8>(bytes, 317, 0, 7)
