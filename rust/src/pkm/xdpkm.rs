...
use crate::pkm::types::{Gender, Stats, ContestStats};
...
impl Pkm<196, 196> for XDPKM {
	...
	fn from_bytes(bytes: &[u8]) -> Result<Self, String> {
		...
		let mon = XDPKM {
			...
			moves: [u16::from_be_bytes(to_sized_array(&bytes[128..130])), u16::from_be_bytes(to_sized_array(&bytes[130..132])), u16::from_be_bytes(to_sized_array(&bytes[132..134])), u16::from_be_bytes(to_sized_array(&bytes[134..136]))],
			...
			contest: ContestStats::from_bytes(to_sized_array(&bytes[174..180])),
	...
	fn write_bytes(&self, bytes: &mut [u8; 196]) {
				...
				bytes[157..163].copy_from_slice(&self.evs.to_bytes());
				bytes[169..175].copy_from_slice(&self.ivs.to_bytes());
				bytes[174..180].copy_from_slice(&self.contest.to_bytes());
