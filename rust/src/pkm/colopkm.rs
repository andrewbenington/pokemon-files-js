...
use crate::pkm::types::{Gender, FlagSet, Stats, ContestStats};
...
impl Pkm<312, 312> for COLOPKM {
	...
	fn from_bytes(bytes: &[u8]) -> Result<Self, String> {
		...
		let mon = COLOPKM {
			...
			stat_level: bytes[96],
			moves: [u16::from_be_bytes(to_sized_array(&bytes[120..122])), u16::from_be_bytes(to_sized_array(&bytes[122..124])), u16::from_be_bytes(to_sized_array(&bytes[124..126])), u16::from_be_bytes(to_sized_array(&bytes[126..128]))],
