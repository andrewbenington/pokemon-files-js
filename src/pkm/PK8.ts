...
export class PK8 {
  static getName() {return 'PK8'}
  format: 'PK8' = 'PK8'
  static getBoxSize() {return 344 }
...
dataView.getUint16(0x88, true),
      ...
      const other = arg
        ...
        this.movePP = adjustMovePPBetweenFormats(this, other).filter((_, i) => other.moves[i] <= PK8.maxValidMove())
        this.movePPUps = other.movePPUps.filter((_, i) => other.moves[i] <= PK8.maxValidMove())
        this.relearnMoves = other.relearnMoves?.filter((_, i) => other.moves[i] <= PK8.maxValidMove()) ?? [0, 0, 0, 0]
