...
import { Languages, isGameBoy, ItemToString, ItemFromString } from 'pokemon-resources'
...
export class PK2 {
  static getName() {return 'PK2'}
  format: 'PK2' = 'PK2'
  static getBoxSize() {return 32 }
  gameOfOrigin: number
...
dataView.getUint8(0x5),
        ...
        this.movePP = [
byteLogic.uIntFromBufferBits(dataView, 0x17, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x18, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x19, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x1a, 0, 6, false),
]
        this.movePPUps = [
byteLogic.uIntFromBufferBits(dataView, 0x17, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x18, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x19, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x1a, 6, 2, false),
]
      ...
      const other = arg
        ...
        this.movePP = adjustMovePPBetweenFormats(this, other).filter((_, i) => other.moves[i] <= PK2.maxValidMove())
