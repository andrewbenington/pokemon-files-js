...
export class PK1 {
  static getName() {return 'PK1'}
  format: 'PK1' = 'PK1'
  static getBoxSize() {return 33 }
  gameOfOrigin: number
...
dataView.getUint8(0xb),
        ...
        this.movePP = [
byteLogic.uIntFromBufferBits(dataView, 0x1d, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x1e, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x1f, 0, 6, false),byteLogic.uIntFromBufferBits(dataView, 0x20, 0, 6, false),
]
        this.movePPUps = [
byteLogic.uIntFromBufferBits(dataView, 0x1d, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x1e, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x1f, 6, 2, false),byteLogic.uIntFromBufferBits(dataView, 0x20, 6, 2, false),
]
      ...
      const other = arg
        ...
        this.movePP = adjustMovePPBetweenFormats(this, other).filter((_, i) => other.moves[i] <= PK1.maxValidMove())
