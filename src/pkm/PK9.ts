...
dataView.getUint16(0x88, true),
      ...
      const other = arg
        ...
        this.movePP = adjustMovePPBetweenFormats(this, other).filter((_, i) => other.moves[i] <= PK9.maxValidMove())
        this.movePPUps = other.movePPUps.filter((_, i) => other.moves[i] <= PK9.maxValidMove())
        this.relearnMoves = other.relearnMoves?.filter((_, i) => other.moves[i] <= PK9.maxValidMove()) ?? [0, 0, 0, 0]
